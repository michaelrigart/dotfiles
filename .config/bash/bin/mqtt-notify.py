...
def notify(summary, body):
    if platform.system() == "Linux":
        notify_ubuntu(summary, body)
    elif platform.system() == "Darwin":
        notify_osx(summary, body)

def notify_ubuntu(summary, body):
...
def notify_osx(summary, body):
    Notifier.notify(body, title=summary, activate='com.apple.Terminal')
